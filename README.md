# FridTerm — A Free macOS Terminal
...
![FridTerm showing multiple terminal panes arranged in a flexible grid layout.](docs/fridterm_demo_main.png)
...
![Tab, Grid, and Frid modes](docs/fridterm_demo_tab_mode.png)

**Flexible grid layout** — Drag terminals into place and build layouts that match your workflow.

![Flexible demo](docs/fridterm_demo_2.png)
